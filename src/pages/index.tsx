    ...
    <>
      ...
      <LazyMotion features={loadFeatures}>
        <m.main className="font-sans" variants={container}>
          ...
          <m.section variants={item} className="pt-20 pb-28 bg-gray-700 relative block light:bg-gray-300">
            <div className="container mx-auto px-4 lg:pt-12 lg:pb-28">
              ...
              <div className="mt-30 pt-30 bottom-0 right-0 w-full absolute pointer-events-none overflow-hidden bg-transparent transition-all duration-200 left-1/2 transform -translate-x-1/2 scale-x-[-1]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2560"
                  height="200"
                  viewBox="0 0 2560 200"
                  className="fill-blue-50 stroke-blue-500 fill-slate-900"
                >
                  <path
                    strokeWidth="2"
          ...
          <m.section variants={item} className="pt-20 mt:20 pb-20 relative block bg-slate-900">
            <div className="container mx-auto px-4 lg:pt-12 lg:pb-28">
              <m.div
                ref={ref2}
                variants={variants2}
              ...
              <div className="mt-20 pt-20 bottom-0 right-0 w-full absolute pointer-events-none overflow-hidden bg-transparent transition-all duration-200 left-1/2 transform -translate-x-1/2 scale-x-[-1]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="2560"
                  height="200"
