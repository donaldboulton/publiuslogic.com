...
const ButtonWrapper = props => <div style={{ position: 'relative', display: 'flex', justifyContent: 'space-between', alignItems: 'center', top: '40px', }} {...props} />
...
export const Code = ({ codeString, className, children, metastring, ...props }) => {
  ...
  const enterFullscreenIconVariants = {
    enterFullscreen: { opacity: 0 },
    exitFullscreen: { opacity: 1 },
  };

  const exitFullscreenIconVariants = {
    enterFullscreen: { pathLength: 1 },
    exitFullscreen: { pathLength: 0 },
  };
      ...
      <Wrapper ref={ref}> 
          ...
          >
            ...
            >
              <motion.path
                ...
                initial={false}
                animate={isFullscreen ? 'enterFullscreen' : 'exitFullscreen'}
        ...
        >
          {({ className, style, tokens, getLineProps, getTokenProps }) => (
            <div className="gatsby-highlight nav-scroll" data-language={language}>                                                                 
              <pre
                className={className}
