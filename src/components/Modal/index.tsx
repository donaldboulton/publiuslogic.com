        ...
        >
          ...
          <div className="fixed z-10 inset-0 overflow-y-auto">
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
              ...
              >
                <Dialog.Panel className="relative inline-block align-bottom bg-gray-300 dark:bg-gray-200 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                  <div className="bg-gray-300 dark:bg-gray-900 text-slate-900 dark:text-slate-300 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:items-start">
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p key={dialogContent} className="text-sm text-gray-900 dark:text-slate-200">
                            {children}
                          </p>
                        </div>
                      </div>
