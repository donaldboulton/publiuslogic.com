...
export default connectSearchBox(
  ({ refine, currentRefinement, className, onFocus, ...rest }) => (
    <form className="group relative">
      <svg width="20" height="20" fill="currentColor" className="absolute left-3 top-1/2 -mt-2.5 text-gray-400 pointer-events-none group-focus-within:text-purple-500" aria-hidden="true">
