      ...
      <div className="sm:flex sm:items-start">
        ...
        <div className="-mt-1 text-center sm:mt-0 sm:ml-4 sm:text-left">
          <div className="text-base leading-6">
            <WavingHand />{' '}
            <span className="font-medium text-slate-800 dark:text-slate-200"> Developed and Written by: </span>{' '}
            <span className="italic font-medium text-slate-800 dark:text-slate-200">Donald Boulton</span>
            <Applause />
          </div>
