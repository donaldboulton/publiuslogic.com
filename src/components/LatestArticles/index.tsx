...
export default function LatestArticles() {
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto bg-slate-300 dark:bg-slate-800 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto py-4 sm:py-8 lg:py-10 lg:max-w-none">
          ...
          <div className="mt-6 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-2 xl:grid-cols-3 lg:gap-x-6">
            <div className="mb-4 lg:mb-0  p-4 lg:p-0 relative rounded-lg block xl:col-span-2 text-slate-200 dark:text-slate-200">
              <div className="mb-6">
                <Link to={`/${post.slug}`}>
                ...
                <Link to={`/${post.slug}`}>
                  <h2 className="text-4xl font-bold mt-2 mb-2 leading-tight">{post.frontmatter.title}</h2>
                </Link>
