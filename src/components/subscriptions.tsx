              ...
              <Honeypot />
                ...
                <div className="p-1 mx-auto space-x-1">
                  <form className="group relative flex items-center text-fuchsia-600">
                    <svg width="20" height="20" fill="currentColor" className="absolute left-3 top-1/2 -mt-2.5 text-fuchsia-600 pointer-events-none group-focus-within:text-fuchsia-600" aria-hidden="true" viewBox="0 0 512 512">
                  ...
                  <span className="block space-x-2">
                    <button type="button" className="p-2 ml-2 border border-transparent text-sm font-medium rounded-md text-gray-200 bg-fuchsia-500 hover:bg-fuchsia-700 shadow-lg shadow-fuchsia-700/50" type="submit">Subscribe</button>
                  </span> 
                  </form>                  
                </div>
            </>
