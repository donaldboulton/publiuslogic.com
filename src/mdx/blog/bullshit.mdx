...
Intergalactic wars are not just necessarily against forms of Man but between Planets the objective then is to eliminate your enemy by killing there planet and thus, there form of mankind; then you have no future enemy's. Kill them all is the only logical course!
