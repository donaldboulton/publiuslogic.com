...
tags: [Cookies, Gdpr]
category: Tech 
image: ../../../static/assets/cookies.jpg
---

## Cookie Consent GDPR

![Cookie Consent without External Scripts](../../../static/assets/cookies.jpg)
...
```tsx:title=src/components/CookieConsent.tsx {3-9}
...
Cookie's Explained In  [Privacy Page](/privacy/#cookies-beacons)