...
Give [@GatsbyJs](https://twitter.com/gatsbyjs), [@GatsbyChangelog](https://twitter.com/GatsbyChangelog) or Paul Scanlon, [@PaulieScanlon](https://twitter.com/PaulieScanlon) to follow on Twitter, and keep an eye out for updates.
